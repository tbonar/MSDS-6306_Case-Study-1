...
## Introduction
###
To determine the make up of a new beer for Budwiser, an exploratory data analysis of beers and breweries from the United States was conducted.Comparing the Alcohol By Volume (ABV) and International Bitterness Unit (IBU) of each beer, a modern new beer was determined for Budwiser's upcoming luxury beer release. By analyzing the data, the goal was to create the perfect beer highlighted with natural flavors, a soaring ABV and a low IBU. Budweiser presents 'Q-Tine' its newest luxury beer. 
###
